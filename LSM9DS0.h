 ...
 * @author Modification: Bruno Laurencich @ [Chordata OSMS](http://chordata.cc)
...
// The LSM9DS0 functions over both I2C or SPI. This library for now supports just the i2c.
enum interface_mode
{
	MODE_SPI,
	MODE_I2C,
...
public:
	...
	// The constructor will set up a handful of private variables.
	// Input:	
	//	- adapter = An initialized I2C_Device object representing the hardware adapter device
	//	
	...
	//				
	LSM9DS0(I2C_Device *_adapter, 
			uint8_t gAddr = LSM9DS0_G, 
			uint8_t xmAddr = LSM9DS0_XM);
	...
	//	- aABW = Anti alias bandwidth of the acceletometer. accel_abw.
	...
	// gyro, 100 Hz for accelerometer, 50 Hz for accelerometer, 100 Hz for magnetometer.
	...
	uint16_t begin(	gyro_scale 	gScl = G_SCALE_245DPS, 
					...
					accel_odr 	aODR = A_ODR_100, 
					accel_abw 	aABW = A_ABW_50, 
...
private:	
	//This is a heritage of the original arduino Library. This one supports just i2c 
